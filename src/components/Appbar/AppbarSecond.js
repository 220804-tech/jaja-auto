...
export default function AppbarSecond(props) {
    ...
    return (
        <>
            ...
            <View style={[styles.appBar, { flex: 0, height: Hp('7%'), backgroundColor: props.backgroundColor ? props.backgroundColor : colors.BlueJaja, alignItems: 'center', paddingBottom: 0 }]}>
