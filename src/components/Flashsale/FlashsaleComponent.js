...
import { styles, Ps, Language, useNavigation, FastImage, colors, Wp, useFocusEffect, Hp, ServiceCore, Countdown, ServiceProduct, Utils } from '../../export'
    ...
    return (
        <>
            {reduxdashFlashsale ?
                <LinearGradient
                    // '#FFFFFF'
                    colors={[colors.RedFlashsale, colors.RedFlashsale, '#FFFFFF']}
                    style={{
                        flex: 1,
                    }}
                >
                    <View style={[styles.column, styles.p_3]}>
                        ...
                        <View style={[styles.row_start_center, { height: Wp('6%') }]}>
                            <Countdown status={true} size={10} wrap={5.5} sparator={14} home={true} justify='flex-start' backgroundColor='transparent' />
                        </View>
                        {reduxdashFlashsale && reduxdashFlashsale.length ?
                            <FlatList
                                ...
                                renderItem={({ item, index }) => {
                                    return (
                                        <TouchableOpacity
                                            style={[Ps.cardProduct, { marginRight: 11, width: Wp('33%'), height: Wp('57%'), alignItems: 'center', elevation: 0 }]}
