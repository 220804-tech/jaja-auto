...
import { styles, Ps, useNavigation, FastImage, colors, Wp, useFocusEffect, RFValue, ServiceProduct, Utils, HeaderTitleHome } from '../../export'
...
export default function NearestStore() {
    ...
    return (
        <View style={[styles.column, styles.pb_4, { backgroundColor: colors.BlueJaja }]}>
            ...
            <View style={[styles.column, { backgroundColor: colors.White }]}>
                <HeaderTitleHome title='Berdasarkan Toko Terdekat' />
