...
class RegisterScreen extends Component {
    ...
    handleFirstName = (e) => {
        try {
            ...
            console.log("🚀 ~ file: RegisterScreen.js ~ line 66 ~ RegisterScreen ~ error", error)
        }
    };
    ...
    handleLastName = (e) => {
        try {
            ...
            console.log("🚀 ~ file: RegisterScreen.js ~ line 76 ~ RegisterScreen ~ error", error)
        }
    };
    ...
    handlePassword = (e) => {
        try {
            ...
            console.log("🚀 ~ file: RegisterScreen.js ~ line 93 ~ RegisterScreen ~ error", error)
        }
    };
    ...
    handleEmail = (e) => {
        try {
            ...
            console.log("🚀 ~ file: RegisterScreen.js ~ line 121 ~ RegisterScreen ~ error", error)
