                    ...
                    {details && Object.keys(details).length ?
                        reduxOrderStatus === "Pengiriman" ?
                            <View style={{ zIndex: 100, height: Hp('5.5%'), width: '97%', backgroundColor: 'transparent', flex: 0, flexDirection: 'row', justifyContent: 'space-between', alignSelf: 'center', marginBottom: '2%' }}>
                                ...
                                <TouchableRipple onPress={() => details.complain ? navigation.navigate('ResponseComplain', { invoice: details.items[0].invoice }) : setmodalComplain(true)} style={[styles.row_center, styles.py_3, { marginHorizontal: '0.5%', borderRadius: 3, flex: 1, backgroundColor: colors.YellowJaja, alignSelf: 'center' }]}>
