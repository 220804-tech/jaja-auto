...
//         redirect: 'follow'
//     };
//     return await fetch("https://jsonx.jaja.id/core/data/province", requestOptions).then(response => response.json())
//         .then(res => {
...
//         redirect: 'follow'
//     };
//     return await fetch(`https://jsonx.jaja.id/core/data/city?province=${id_provinsi}`, requestOptions).then(response => response.json())
...
//         redirect: 'follow'
//     };
//     return await fetch('https://jsonx.jaja.id/core/data/kecamatan', requestOptions)
...
//         redirect: 'follow'
//     };
//     return await fetch(`https://jsonx.jaja.id/core/data/kelurahan?kd_kec=${kd_kec}`, requestOptions)
//         .then(response => response.json())
//         .then(async res => {
//             return await res
//         })
