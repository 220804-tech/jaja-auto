...
export async function productDetailAuto(auth, slug) {
    var myHeaders = new Headers();
    myHeaders.append("Cookie", "ci_session=e4vgchcc5ro2562pjs5mmmn3e7fejuai");
    ...
    return fetch(`https://api.jaja.id/produk/get?slug=${slug}`, requestOptions)
        .then(response => response.json())
        .then(result => {
            // mengembalikan hasil langsung
